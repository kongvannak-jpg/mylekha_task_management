...
const LoginPage = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-slate-100 dark:bg-slate-900 transition-colors duration-300">
            <div draggable={false} onDragStart={(e) => e.preventDefault()} className='grid grid-cols-1 items-center justify-center lg:grid-cols-2 shadow-lg max-w border border-gray-100 dark:border-slate-700 rounded-xl'>
